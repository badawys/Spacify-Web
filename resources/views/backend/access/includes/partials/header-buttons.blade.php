<div class="pull-right mb-10">
    <div class="btn-group">
        ...
        <ul class="dropdown-menu" role="menu">
            <li>{{ link_to_route('user.index', trans('menus.backend.access.users.all')) }}</li>

            @permission('manage-users')
                <li>{{ link_to_route('user.create', trans('menus.backend.access.users.create')) }}</li>
            @endauth
    ...
    <div class="btn-group">
        ...
        <ul class="dropdown-menu" role="menu">
            <li>{{ link_to_route('role.index', trans('menus.backend.access.roles.all')) }}</li>

            @permission('manage-roles')
                <li>{{ link_to_route('role.create', trans('menus.backend.access.roles.create')) }}</li>
            @endauth
        </ul>
    </div><!--btn group-->
</div><!--pull right-->
