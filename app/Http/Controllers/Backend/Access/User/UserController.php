...
class UserController extends Controller
{
    ...
    public function store(StoreUserRequest $request)
    {
        ...
        return redirect()->route('user.index')->withFlashSuccess(trans('alerts.backend.users.created'));
    }
    ...
    public function updatePassword(User $user, UpdateUserPasswordRequest $request)
    {
        ...
        return redirect()->route('user.index')->withFlashSuccess(trans('alerts.backend.users.updated_password'));
    }
